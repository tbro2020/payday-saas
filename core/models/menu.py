...
class Menu(Base):
    ...
    icon = fields.ChoiceField(verbose_name=_('icon'), choices=ICONS, max_length=100, null=True, default=None)
    children = fields.ModelSelect2Multiple(ContentType, verbose_name=_('sous-menu'))
