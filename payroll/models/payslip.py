...
class Payslip(Base):
    ...
    list_filter = ('employee__branch', 'employee__grade', 'employee__designation', 
                   'employee__payment_method', 'employee__payer_name', 'employee__status', 
                   'employee__date_of_birth', 'employee__date_of_join')
