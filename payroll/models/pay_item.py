...
class PayItem(Base):
    ...
    amount = models.FloatField(_('montant'), default=0)
    ...
    payslip = models.ForeignKey('payroll.payslip', verbose_name=_('fiche de paie'), on_delete=models.CASCADE, editable=False)
